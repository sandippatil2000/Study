...
public static class Option1RephraseQuestion
{
    ...
    public static async Task Run(bool importData, Movie[] movieDataForRag, ChatMessage question, OpenAIClient client, SqlServerCollection<Guid, MovieVectorStoreRecord> collection, Secrets secrets)
    {
        if (importData)
        {
